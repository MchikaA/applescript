...
-- タイトル
set theTitle to "Chrome のウィンドウサイズを変更"

-- リスト
set theList to {"横600px×縦600px", "横1300px×縦1000px", "サイズを入力する"}

-- リストから項目を選択し変数へ代入。注: キャンセルボタンクリックはfalseが入る
set selectSize to (choose from list theList with prompt "ウィンドウサイズを選択" with title theTitle OK button name "OK" cancel button name "キャンセル")
