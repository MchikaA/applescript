...
*)
-- リスト1
set myList1 to {"Adobe ID", "Apple ID", "社内 サーバ（Basic認証）", "社内 メール（sample@example.net）", "社内 FTP（example.net）"}
...
*)
--リスト2
set myList2 to {{"ID: sample1", "パスワード: sample1", "メモ: sample1", ""}, {"ID: sample2", "パスワード: sample2", "メモ: sample2", ""}, {"ID: sample3", "パスワード: sample3", "メモ: sample3", ""}, {"ID: sample4", "パスワード: sample4", "メモ: sample4", ""}, {"ホスト or サーバ: sample5", "ユーザ: sample5", "パスワード: sample5", "メモ: sample5"}}

-- 区切り文字
set myDelimiter to ": "

--リスト1の長さを取得
set listLength to length of myList1
...
repeat with i from 1 to listLength
	set list1Item to item i of myList1 as string
...
repeat with i from 1 to listLength
	if selectAcc is {item i of serialNumList as string} then
		set keyTitle to item i of myList1 as string
		set key1 to item 1 of item i of myList2 as string
		set key2 to item 2 of item i of myList2 as string
		set key3 to item 3 of item i of myList2 as string
		set key4 to item 4 of item i of myList2 as string
